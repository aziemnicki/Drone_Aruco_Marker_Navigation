...
class ControllerNode(Node):
    ...
    pos_x = pos_y = pos_z = ori_roll = ori_pitch = ori_yaw = None
    ...
    def __init__(self):
        ...
        self.tello_position = self.create_subscription(ModelStates, '/gazebo/model_states', self.position_callback, 10,
                                                       callback_group=position_cb_group)
    ...
    def mission_func(self):
        ...
        # self.pid_x.setpoint = 1.0
        # self.pid_y.setpoint = 1.0
        self.pid_z.setpoint = 3.0
